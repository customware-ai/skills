...
```bash
pnpm exec node <customware-ai-skill>/scripts/install-ai-elements.mjs persona --cwd .
```

Underlying non-interactive shadcn command used by the installer:

```bash
pnpm dlx shadcn@latest add @ai-elements/persona --yes --path .tmp/customware-ai-elements-install
```
...
See [`persona-obsidian.tsx`](examples/persona-obsidian.tsx) for this official example.
...
See [`persona-mana.tsx`](examples/persona-mana.tsx) for this official example.

### Opal

See [`persona-opal.tsx`](examples/persona-opal.tsx) for this official example.

### Halo

See [`persona-halo.tsx`](examples/persona-halo.tsx) for this official example.

### Glint

See [`persona-glint.tsx`](examples/persona-glint.tsx) for this official example.

### Command

See [`persona-command.tsx`](examples/persona-command.tsx) for this official example.
