...
```bash
pnpm exec node <customware-ai-skill>/scripts/install-ai-elements.mjs test-results --cwd .
```

Underlying non-interactive shadcn command used by the installer:

```bash
pnpm dlx shadcn@latest add @ai-elements/test-results --yes --path .tmp/customware-ai-elements-install
```
...
See [`test-results.tsx`](examples/test-results.tsx) for this official example.
...
See [`test-results-basic.tsx`](examples/test-results-basic.tsx) for this official example.

### With Test Suites

See [`test-results-suites.tsx`](examples/test-results-suites.tsx) for this official example.

### With Error Details

See [`test-results-errors.tsx`](examples/test-results-errors.tsx) for this official example.
