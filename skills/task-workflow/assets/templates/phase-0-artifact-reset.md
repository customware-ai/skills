...
| --- | --- | --- |
| Previous task's `task-workflow/` directory removed, not reused | Pending |  |
| Required artifact files created from templates | Pending |  |
...
| No generated app files, build outputs, databases, or migrations created before Phase 0 gate | Pending |  |
