...
5. Verify representative secondary routes, pages, or workflows until every source-visible screen has direct evidence or a concrete blocker.
6. Compare route map, navigation labels, page hierarchy, section ordering, control surfaces, shell, styling language, typography direction, and logo usage against the active source frontend.
